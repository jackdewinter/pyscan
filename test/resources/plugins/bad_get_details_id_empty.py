...
class BadGetDetailsIdEmpty(ProjectSummarizerPlugin):
    """
    Class to implement a sample plugin that returns an empty id, but everything else is okay.
    """
    ...
    def get_details(self) -> PluginDetails:
        ...
        return PluginDetails(
            "",
            BadGetDetailsIdEmpty.__PLUGIN_NAME,
            BadGetDetailsIdEmpty.__PLUGIN_VERSION,
    ...
    def add_command_line_arguments(
        ...
        """
        parser.add_argument(
            BadGetDetailsIdEmpty.__COMMAND_LINE_ARGUMENT,
            dest=BadGetDetailsIdEmpty.__COMMAND_LINE_OPTION,
            metavar="path",
            action="store",
            default="",
        ...
        return (
            BadGetDetailsIdEmpty.__COMMAND_LINE_ARGUMENT,
            BadGetDetailsIdEmpty.__COMMAND_LINE_OPTION,
        )
