...
class ResultantTestTotals:
    ...
    def __init__(
        ...
        self.measurements: Dict[str, ResultantTestMeasurement] = {}
    ...
    @staticmethod
    def from_dict(input_dictionary: Dict[str, Any]) -> "ResultantTestTotals":
        """
        ...
        new_total = ResultantTestTotals(
            project_name=total_project, report_source=total_report
        )
        for next_measurement_name in total_measurements:
            next_measurement = ResultantTestMeasurement.from_dict(next_measurement_name)
